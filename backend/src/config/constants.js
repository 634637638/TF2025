...
const FEATURE_FLAGS = Object.freeze({
  MOCK_ROUTES_ENABLED: process.env.ENABLE_MOCK_ROUTES === 'true' || process.env.NODE_ENV !== 'production'
});
...
const DEFAULT_CORS_ORIGINS = Object.freeze(parseCsvEnv(process.env.ALLOWED_ORIGINS, [
  'http://localhost:5173',
  'http://localhost:5176',
  'http://localhost:3000',
  'http://127.0.0.1:5173',
