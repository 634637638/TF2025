        ...
        <div class="content admin-page-content">
          ...
          >
            ...
            >
              ...
              <div class="stat-content">
                <div class="stat-value">
                  {{ gitStatus?.branchDisplay || gitStatus?.branch || '-' }}
                </div>
            ...
            >
              <div
                class="stat-icon"
                :class="{ active: gitStatus?.hasChanges }"
              >
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="commit-content">
                        ...
                        <div
                          v-if="hasCommitDetails(commit.message)"
                          class="commit-details"
                        >
                          <div
                            v-if="getCommitDetails(commit.message)"
                          ...
                          <div
                            v-if="getCommitOptimizations(commit.message)"
                            class="detail-section optimizations"
                          >
